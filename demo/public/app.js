...
const LIST_VALID_EMAIL = ["qnn1@rice.edu"]
...
firebase.auth().onAuthStateChanged(function(user) {
  ...
  if (user && !LIST_VALID_EMAIL.includes(user.email)){
    alert("Your email is not authorized to enter the page")
    checkAccount = false
  }
  user && checkAccount ? handleSignedInUser(user) : handleSignedOutUser();
});
